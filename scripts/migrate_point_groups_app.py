...
replace_once("internal/cli/completions.go", "init-config validate-config test-connection status identify programs tags points read read-multi read-point write write-multi write-point watch watch-multi watch-point completions version", "init-config validate-config test-connection status identify programs tags points groups read read-multi read-point read-group write write-multi write-point write-group watch watch-multi watch-point watch-group completions version")
