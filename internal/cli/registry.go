...
var cliRegistry = command.Registry{
	...
	GlobalFlags: []command.Flag{
		...
		{Name: "path", TakesValue: true, Summary: "CIP route path"},
	...
	Commands: []command.Command{
		...
		{Name: "read", Summary: "Read one tag", Flags: registryFlags("type")},
		...
		{Name: "read-group", Summary: "Read a configured point group"},
		{Name: "write", Summary: "Write one tag", Flags: registryFlags("type", "value", "yes", "dry-run")},
		...
		{Name: "write-group", Summary: "Write selected points in a group", Flags: registryFlags("set", "yes", "dry-run")},
		{Name: "watch", Summary: "Poll one tag", Flags: registryFlags("type", "interval", "count", "duration")},
		{Name: "watch-multi", Summary: "Poll several typed tags", Flags: registryFlags("item", "interval", "count", "duration")},
		{Name: "watch-point", Summary: "Poll a configured named point", Flags: registryFlags("interval", "count", "duration")},
		{Name: "watch-group", Summary: "Poll a configured point group", Flags: registryFlags("interval", "count", "duration")},
